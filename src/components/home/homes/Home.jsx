            ...
            <section className="home" id="more-item">
                <div className="home-container flex">
                    ...
                    <div className="right topMargin">
                        ...
                        <p className="selfIntro">Hello, I'm LingXiu, a software developer with a Master's degree in
                            Machine Learning and Computer Vision from the Australian National University.
                            My technical stack includes Python, JavaScript, C#, and Java, and I'm experienced in both
                            front-end and back-end development. I enjoy creating
                            responsive, intuitive, and efficient software solutions.</p>
